...
describe("Update method", () => {
    ...
    afterAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield orderService.deleteOrder(data.gigId, data.sellerId, data.orderId);
        yield orderNotificationService.deleteOrderNotifications(data.buyerUsername, data.sellerUsername, data.orderId);
        yield orderNotificationService.deleteOrderNotifications(data.sellerUsername, data.sellerUsername, data.orderId);
    }));
    describe("markNotificationAsRead())", () => {
        it("Should throw an error because notificationId is invalid", () => __awaiter(void 0, void 0, void 0, function* () {
            const notificationId = "wrong-notification-id";
            yield expect(orderNotificationService.markNotificationAsRead(notificationId)).rejects.toThrow("Invalid notification id");
        }));
        it("Should return not found message", () => __awaiter(void 0, void 0, void 0, function* () {
            const notificationId = "660246d911906db940f1c749";
            yield expect(orderNotificationService.markNotificationAsRead(notificationId)).rejects.toThrow("OrderNotification is not found");
        }));
        it("Should successfully updated isRead to true in database", () => __awaiter(void 0, void 0, void 0, function* () {
            const orderNotificationFromDb = yield orderNotificationService.getNotificationByUserToId(data.sellerUsername);
            const result = yield orderNotificationService.markNotificationAsRead(orderNotificationFromDb[0]._id);
