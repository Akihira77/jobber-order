...
function createConnection() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            (0, config_1.logger)("queues/connection.ts - createConnection()").info("OrderService connected to RabbitMQ successfully...");
            closeConnection(channel, connection);
            return channel;
        }
        catch (error) {
            (0, config_1.logger)("queues/connection.ts - createConnection()").error("OrderService createConnection() method error:", error);
            process.exit(1);
        }
    });
}
